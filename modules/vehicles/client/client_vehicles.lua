...
RegisterNUICallback('getPlayers', function(data, cb)
    ...
    TriggerCallback('roots-search:client:getPlayers', function(result)
        ...
        local createdVehicle = json.encode(result)
        if #result == 1 then
...
RegisterNUICallback('editVehicle', function(data, cb)
    ...
    TriggerCallback('roots-search:server:editVehicle', function(result)
        ...
        --TriggerServerEvent('roots-loader:server:VehicleChanged')
        --TriggerClientEvent('QBCore:Client:OnSharedUpdate', -1, 'Vehicles', vehicleName, vehicle)

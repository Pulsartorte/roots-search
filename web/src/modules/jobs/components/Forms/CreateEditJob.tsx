...
const CreateEditJob = ({jobs, jobData, handleCreate, handleEdit, handleClose}: Props) => {
    const {register, handleSubmit, formState: {errors}, watch, control} = useForm<Job>({
    ...
    const imageUrl = getTextWithVariable(imagePrefix, jobData?.image || '');
            ...
            <StyledDocument>
                <Box style={{width: "calc(60vh - 3.6vh)"}}>
                    <Typography variant="h5" gutterBottom style={{marginBottom: "1vh"}}>
                        {jobData ? texts.editItemTitle : texts.createItemTitle}
                    </Typography>
                    ...
                    <Grid container justifyContent="center" style={{marginTop: "1.5vh"}}>
                        <Button type="submit" variant="contained" color="success" fullWidth>
                            {jobData ? texts.editItemBtn : texts.createItemBtn}
                        </Button>
                    </Grid>
